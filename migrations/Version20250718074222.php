 ...
 */
final class Version20250718074222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart (id SERIAL NOT NULL, client_id INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE cart_item (id SERIAL NOT NULL, cart_id INT DEFAULT NULL, product_id INT DEFAULT NULL, PRIMARY KEY(id))');
